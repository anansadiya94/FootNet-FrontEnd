...
class StaticDBManager {
    ...
    static var users = [
        ...
        User(id: 3, profileType: .Player, name: "Marti", surname: "Leonel Brude", email: "marcos@gmail.com", phone: "12121212", sex: "male".localize(), birthday: "12/02/1990", nationality: "AFG".localize(), location: "barcelona".localize(), actualClub: "ud_parc".localize(), photo: "defaultProfilePhoto", bio: "El mejor delantero en el mundo hoy en día.", record: "2011 Sabadell", favoritePosition: "pos10".localize(), preferredPositions: "pos3".localize(), weight: "90 kg", height: "198 cm", amIFollowing: false, active: true),
